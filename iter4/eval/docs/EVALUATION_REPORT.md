...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **`v1_baseline`** | 기본 룰베이스 (`SPEED 1.6`, `EXTEND 0.40`) | 0.3666 | 0.3548 | **0.3793** | 11 / 20 / 18 | 9회 | **169.7 ms** |
| **`v2_anti_sway`** | 풋워크 억제 룰베이스 (`SPEED 1.85`, `EXTEND 0.45`) | 0.3461 | 0.3913 | 0.3103 | 9 / 14 / 20 | **4회 (-5회 🟢)** | 229.7 ms |
| **`v3_iter4_eval`** | 밸런스 튜닝 룰베이스 (`SPEED 1.75`, `EXTEND 0.42`) | 0.3704 | **0.4000** | 0.3448 | 10 / 15 / 19 | 5회 | 206.7 ms |
| **`v4_tcn_hybrid`** | Causal TCN 딥러닝 모드 (`CONF 0.40`) | 0.3666 | 0.3548 | **0.3793** | 11 / 20 / 18 | 9회 | **169.7 ms** |
| **`v5_tcn_optimized`** ⭐ | **TCN 딥러닝 최적화 (`CONF 0.32`, `SPEED 1.65`)** | **0.3793** | 0.3793 | **0.3793** | **11 / 18 / 18** | **7회 (-2회 🟢)** | **169.7 ms** |
